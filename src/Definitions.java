public class Definitions  {
    ...
    static final int BUTTON_TO_START_WIDTH = 100;
    static final int BUTTON_TO_START_HEIGHT = 50;
    static final int ZERO = 0;
    static final int winner = 25;
    static final int FONT_SIZE = 35;
    static final int BODY_COLOR_RANDOM = 255;
